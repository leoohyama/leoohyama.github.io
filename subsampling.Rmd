...
samples<-sample(1:nrow(species_roster1), 5, replace = F) #I then sample 5 random rows (species) w/o replacement from cell 209
species_roster1<-species_roster1[samples,] # I then grab the randomly sampled rows from the species roster of cell 209
